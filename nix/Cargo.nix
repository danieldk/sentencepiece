...
rec {
  ...
  rootCrate = rec {
    packageId = "sentencepiece 0.1.1 (path+file:///home/daniel/git/sentencepiece)";
  ...
  crates = {
      ...
      = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "sentencepiece-sys 0.1.1 (path+file:///home/daniel/git/sentencepiece/sentencepiece-sys)";
          }
        ];
        features = {
    ...
    "sentencepiece-sys 0.1.1 (path+file:///home/daniel/git/sentencepiece/sentencepiece-sys)"
      = rec {
